            ...
            <nav className={styles.nav}>
                <div className={styles.wrapper}>
                    ...
                    <div className={`${styles.navLinks} ${menuOpen ? styles.active : ""}`}>
                        <button className={`${styles.btn} ${styles.closeBtn}`} onClick={closeMenu}>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#" onClick={closeMenu}>Трансляции</a>
                            </li>
                            <li className={styles.dropdown}>
                                <a href="#" className={styles.desktopItem}>Лотереи</a>
                                <span className={styles.mobileItem} onClick={() => setShowDrop(!showDrop)}>
                                    Лотереи
                                </span>
                                <ul className={`${styles.dropMenu} ${showDrop ? styles.show : ""}`}>
                                    <li><a href="#">Гибкое Бинго</a></li>
                                    <li><a href="#">Лотерея-судоку</a></li>
                                    <li><a href="#">Лотерея-сапер</a></li>
                                    <li><a href="#">Лотерея-тетрис</a></li>
                                </ul>
                            </li>
                            <li className={styles.megaMenu}>
                                <a href="#" className={styles.desktopItem}>Информация</a>
                                <span className={styles.mobileItem} onClick={() => setShowMega(!showMega)}>
                                    Информация
                                </span>
                                <div className={`${styles.megaBox} ${showMega ? styles.show : ""}`}>
                                    <div className={styles.content}>
                                        ...
                                        <div className={styles.row}>
                                            ...
                                            <ul className={styles.megaLinks}>
                                                ...
                                                <li><a href="#">Призовая структура</a></li>
                                                <li><a href="#">Выигрышные номера</a></li>
                                            </ul>
                                        </div>
                                        <div className={styles.row}>
                            ...
                            <li>
                                <div className={styles.row}>
                                    <div className={styles.dropdown}>
                                        <a href="#"
                                           onClick={() => log === "logIn" ? setAuthOpen(true) : handleLogout()}>
                                            {log === "logIn" ? "Регистрация | Вход" : "Выйти"}
                                        </a>
                                        <span className={styles.mobileItem} onClick={() => setShowDrop1(!showDrop1)}>Мой аккаунт</span>
                                        <ul className={`${styles.dropMenu} ${showDrop1 ? styles.show : ""}`}>
                                            <li><a href="#">Мои билеты</a></li>
                                            <li><a href="#">Мои достижения</a></li>
                                            <li><a href="#">История бонусов</a></li>
                                        </ul>
                    ...
                    <button className={`${styles.btn} ${styles.menuBtn}`} onClick={toggleMenu}>
